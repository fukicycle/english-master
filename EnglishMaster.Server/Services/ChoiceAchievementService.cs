...
{
    public sealed class ChoiceAchievementService : IAchievementService
    {
        private readonly DB _db;
        private readonly ILogger<ChoiceAchievementService> _logger;
        public ChoiceAchievementService(DB db, ILogger<ChoiceAchievementService> logger)
        {
            _db = db;
            _logger = logger;
        }
